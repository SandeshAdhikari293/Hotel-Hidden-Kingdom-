        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Personals_Addresses_AddressId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AmenityRoomType", x => new { x.AmenitiesId, x.RoomsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_AmenityRoomType_RoomTypes_RoomsId",
                        column: x => x.RoomsId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BedRoomType", x => new { x.BedsId, x.RoomsId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BedRoomType_RoomTypes_RoomsId",
                        column: x => x.RoomsId,
                        principalTable: "RoomTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bookings_Personals_PersonalId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AmenityRoomType_RoomsId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BedRoomType_RoomsId",
                table: "BedRoomType",
                column: "RoomsId");

            migrationBuilder.CreateIndex(
                name: "IX_Bookings_PersonalId",
                table: "Bookings",
                column: "PersonalId");

            migrationBuilder.CreateIndex(
                name: "IX_Personals_AddressId",
                table: "Personals",
                column: "AddressId");
