...
namespace Hotel.Migrations
{
    ...
    [Migration("20231021204553_bookingCartRooms")]
    partial class bookingCartRooms
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BookingCartRoom", b =>
                {
                    b.Property<Guid>("BookingCartsId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("SelectedRoomsId")
                        .HasColumnType("uniqueidentifier");

                    b.HasKey("BookingCartsId", "SelectedRoomsId");

                    b.HasIndex("SelectedRoomsId");

                    b.ToTable("BookingCartRoom");
                });
            ...
            modelBuilder.Entity("Hotel.Models.BookingCart", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("BookingCartRoom", b =>
                {
                    b.HasOne("Hotel.Models.BookingCart", null)
                        .WithMany()
                        .HasForeignKey("BookingCartsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Hotel.Models.Room", null)
                        .WithMany()
                        .HasForeignKey("SelectedRoomsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
